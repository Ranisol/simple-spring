...
@Service("simpleOrderServiceWithEventListener")
...
public class SimpleOrderService {
    ...
    public void createOrderWithPointFail() {
        ...
        publishCreateOrderWithPointFailEvent(event);
    }
    ...
    private void publishCreateOrderWithPointFailEvent(SimpleOrderCreatePointFailEvent event) {
        eventPublisher.publishEvent(event);
    }
